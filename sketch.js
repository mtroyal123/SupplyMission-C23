...
function setup() {
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
	 ...
	 boxBottom = createSprite(width/2,650,200,20, {isStatic:true});
	 boxBottom.shapeColor = color("red");
	 World.add(world,boxBottom);

	 boxSide1 = createSprite(300,610,20,100, {isStatic:true});
	 boxSide1.shapeColor = color("red");
	 World.add(world,boxSide1);

	 boxSide2 = createSprite(500,610,20,100, {isStatic:true});
